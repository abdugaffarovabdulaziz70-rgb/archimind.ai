      ...
      >
        <div className="card-luxury p-8 lg:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-luxury-silver">Sign in to continue your architectural journey</p>
          </div>
          ...
          {success && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mb-6 p-4 rounded-xl bg-green-500/10 border border-green-500/30 text-green-400 text-sm text-center"
            >
              {success}
            </motion.div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-3 text-sm text-luxury-silver cursor-pointer group">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gold-500/30 bg-luxury-charcoal text-gold-500 focus:ring-gold-500/30"
                />
                <span className="group-hover:text-luxury-pearl transition-colors">Remember me</span>
              </label>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-luxury-charcoal text-luxury-silver">or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              type="button"
              className="flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white/5 border border-gold-500/10 hover:border-gold-500/30 hover:bg-gold-500/5 transition-all"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24">
                <path fill="currentColor" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.28v2.73h3.57c2.08-1.92 3.28-4.74 3.28-8.02z"/>
                <path fill="currentColor" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.73c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
